...
class OBJFileReader
{
	public:
		...
		static int secondPassOBJRead(const char* filename, int nVerts, int nNormals, int nTexcoords, Triangle* inTriangles);

		static int ImportObjMesh(const char* filename, Triangle** triangles);
};