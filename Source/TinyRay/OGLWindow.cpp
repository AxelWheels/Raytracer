...
BOOL OGLWindow::KeyUp(WPARAM key)
{
	...
	case VK_F7:
		m_pRayTracer->m_traceflag = (RayTracer::TraceFlag)(RayTracer::TRACE_AMBIENT | RayTracer::TRACE_DIFFUSE_AND_SPEC
			| RayTracer::TRACE_REFRACTION | RayTracer::TRACE_REFLECTION | RayTracer::TRACE_SHADOW | RayTracer::TRACE_ANTIALIASING);
		break;
	case VK_F8:
		m_pRayTracer->m_traceflag = (RayTracer::TraceFlag)(RayTracer::TRACE_AMBIENT | RayTracer::TRACE_DIFFUSE_AND_SPEC
			| RayTracer::TRACE_REFRACTION | RayTracer::TRACE_REFLECTION | RayTracer::TRACE_SHADOW | RayTracer::TRACE_CAMERAROTATION);
		break;
	}
